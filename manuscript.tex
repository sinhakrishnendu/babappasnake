...
In the default workflow path, RBH is run directly and must itself recover usable strict 1:1 ortholog support.
An optional comparison mode also runs OrthoFinder and selects the orthogroup with stronger strict 1:1 support.
